...
function setup() {
  ...
  ground = createSprite(displayWidth-1200,displayHeight-300,displayWidth-20,20);
  ...
  invisibleGround = createSprite(displayWidth-1200,displayHeight-290,400,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth-100,displayHeight-300,10,40);
    //obstacle.debug = true;
